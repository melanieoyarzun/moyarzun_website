...
draft: false
event: Women in Data Science (WiDS) Budapest
excerpt: Organizing Committee member and Datathon Lead for the first WiDS Budapest Datathon, helping shape the challenge, coordinate mentors, and create a welcoming day of data work.
layout: single
location: Budapest, Hungary
show_post_time: false
subtitle: Organizing Committee and Datathon Lead
title: WiDS Budapest Datathon · Budapest, Hungary
---
...
<div class="mv4">
  <div class="aspect-ratio aspect-ratio--16x9">
    <iframe
      ...
      title="WiDS Budapest Highlights"
      loading="lazy"
...
<div class="talk-featured-pair">
  ...
  <figure>
    <img src="featured.png" alt="Official WiDS Budapest Conference 2025 visual" />
    <figcaption>The official event visual connecting the Budapest chapter to the broader WiDS identity.</figcaption>
  </figure>
</div>
...
<div class="talk-gallery">
  <figure>
    <img src="all.jpg" alt="Group photo from WiDS Budapest Datathon 2025" />
    <figcaption>A group photo that captures the collective energy of the day.</figcaption>
  </figure>
  <figure>
    <img src="IMG_6817.jpeg" alt="WiDS Budapest Datathon opening screen" />
    <figcaption>The room before the day was fully underway, with the main screens ready for the datathon.</figcaption>
  </figure>
  <figure>
    <img src="IMG_6827.jpeg" alt="Participants working at WiDS Budapest Datathon" />
    <figcaption>Participants settling into the challenge and starting to work in teams.</figcaption>
  </figure>
  <figure>
    <img src="IMG_6866.jpeg" alt="Stage moment at WiDS Budapest Datathon" />
    <figcaption>One of the presentation moments that gave the day its public rhythm.</figcaption>
  </figure>
  <figure>
    <img src="IMG_6889.jpeg" alt="Group photo at WiDS Budapest Datathon" />
    <figcaption>A wider group moment from the event.</figcaption>
  </figure>
  <figure>
    <img src="PXL_20250926_115414480.MP.jpg" alt="WiDS Budapest Datathon session" />
    <figcaption>One of the hands-on working sessions during the datathon.</figcaption>
  </figure>
  <figure>
    <img src="PXL_20250926_115514173.MP.jpg" alt="WiDS Budapest Datathon presentation room" />
    <figcaption>A wider view of the room, the screens, and the pace of the day.</figcaption>
  </figure>
  <figure>
    <img src="PXL_20250926_122550303.jpg" alt="Participants collaborating at WiDS Budapest" />
    <figcaption>Exactly the kind of teamwork and mentor support I hoped the event would make possible.</figcaption>
  </figure>
  <figure>
    <img src="PXL_20250926_134514277.MP.jpg" alt="Mentoring moment at WiDS Budapest Datathon" />
    <figcaption>Mentoring in practice, not as a slogan but as part of the structure of the event.</figcaption>
  </figure>
  <figure>
    <img src="img_6915.jpg" alt="Closing photo from WiDS Budapest Datathon" />
    <figcaption>A closing moment from a day I am genuinely proud to have helped organize.</figcaption>
  </figure>
</div>
